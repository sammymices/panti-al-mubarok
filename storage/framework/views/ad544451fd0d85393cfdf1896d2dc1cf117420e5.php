...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="amount" name="amount" class="form-control" placeholder="Angka saja, Contoh: 100000" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control" placeholder="Harapan atau doa untuk anak panti, atau doa khusus yang ingin didoakan untuk Anda sebagai donatur"></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\abc_Gabrielipp\Semester3\projek_laravel\al-mubarok\resources\views/donateform.blade.php ENDPATH**/ ?>