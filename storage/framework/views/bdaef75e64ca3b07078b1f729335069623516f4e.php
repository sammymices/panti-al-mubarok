                ...
                <li class="sidebar-item <?php echo e(request()->routeIs('dashboard.donation.*') ? 'active' : ''); ?>">
                    ...
                    <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item <?php echo e(request()->routeIs('dashboard.donation.uang') ? 'active' : ''); ?>">
                            <a class="sidebar-link" href="<?php echo e(route('dashboard.donation.uang.index')); ?>">Uang</a>
                        </li>
                    </ul>
                </li>
...
</nav><?php /**PATH C:\abc_Gabrielipp\Semester3\projek_laravel\al-mubarok\resources\views/dashboard/layout/sidebar.blade.php ENDPATH**/ ?>