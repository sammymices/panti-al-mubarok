...
Route::prefix('dashboard')->name('dashboard.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Routes for donation uang
    Route::get('/donation/uang', [DonationDashboardController::class, 'viewUang'])->name('donation.uang.index');
    Route::get('/donation/uang/edit/{id}', [DonationDashboardController::class, 'edit'])->name('donation.uang.edit');
    Route::put('/donation/uang/update/{id}', [DonationDashboardController::class, 'update'])->name('donation.uang.update');
    Route::delete('/donation/uang/destroy/{id}', [DonationDashboardController::class, 'destroy'])->name('donation.uang.destroy');
